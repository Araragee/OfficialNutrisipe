...
import { pinDetailMorePinQuery, pinDetailQuery, ingredientBaseValue } from '../utils/data';
...
const PinDetail = ({ user }) => {
  ...
  // useEffect(() => {
  //   fetchIngredientBaseValue()
  // }, [baseVal]);

   const fetchIngredientBaseValue = () => {
    const query = ingredientBaseValue(pinDetail.ingredient);
    if (query) {
      client.fetch(`${query}`)
      .then((data) => {
        setBaseval(data);
          ...
          <div className="w-full p-5 flex-1 xl:min-w-620">
            ...
            <div>
              ...
              {pinDetail.ingredient.map((item, i) => (
                ...
                <div className='float-middle py-4 ml-8'>
              <p style={{ marginBottom: '15px' }} className="font-semibold"> Metric </p>
              {pinDetail.metric.map((item, i) => (
                ...
                <div className='float-middle py-4 ml-8'>
              <p style={{ marginBottom: '15px' }} className="font-semibold"> Ingredients Value: </p>
