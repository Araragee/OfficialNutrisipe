...
const CreateIngredient = ({ user }) => {
  ...
  const handleAddBaseSize = () => {
    const baseSizeItem = {
      ...
      saturatedfat: parseFloat(saturatedFat).toFixed(2),
      transfat:parseFloat(transFat).toFixed(2),
      cholesterol: parseFloat(cholesterol).toFixed(2),
      sodium: parseFloat(sodium).toFixed(2),
      totalcarb: parseFloat(totalCarbohydrates).toFixed(2),
      dietaryFiber: parseFloat(dietaryFiber).toFixed(2),
      sugar: parseFloat(sugar).toFixed(2),
      protein: parseFloat(protein).toFixed(2),
      vitaminA: parseFloat(vitaminA).toFixed(2),
      vitaminC: parseFloat(vitaminC).toFixed(2),
